...
import { useGetLatestBlogQuery } from "../../../redux/features/blogs/blogsApi";
...
const Blogs = () => {
  ...
  const { heading1, heading2, seeArticleBtn, bestTeacher, bestStudent } =
    t("blogs") || {};
  const { name, post, call } = t2("director");

  const { data: latestBlog, isLoading, isError } = useGetLatestBlogQuery();
  ...
  if (isError) {
    return <div className="text-center py-5">Error loading latest blog</div>;
  }
    ...
    <section className="news-section section-padding fix" id="blog">
      <div className="container">
        <div className="section-title-area">
          ...
          <Link
            to="/blogs" // Changed to absolute path
            className="theme-btn"
              ...
              {latestBlog ? (
                  ...
                  <div className="news-content">
                    <ul>
                      <li>
                        ...
                        {latestBlog.category || "Uncategorized"}
                      </li>
                      <li>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        {formatDate(latestBlog.date || latestBlog.createdAt)}
                      </li>
                    </ul>
                    <h3>
                    ...
                    <p className="text-truncate">
                      {" "}
                      {latestBlog.content && latestBlog.content.length > 200
                ...
                <div className="news-single-items">
                  ...
                  <div className="news-content">
                    ...
                    <h3>
                      <Link to="#">
                        Questions to Ask Vendors Before Choosing an <br /> LMS
                        Platform
                      </Link>
                    </h3>
                    <p>
                      Phasellus turpis sapien, venenatis tempus vestibulum in,
                      cursus quis enim. Nunc mollis vitae ipsum sit amet
                      ultrices. Duis in dapibus erat
                    </p>
                    <div className="post-author-items">
                      <div className="post-items">
                        <div className="thumb">
